    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Job Posts</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.index') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="{{ route('admin.jobpost.index') }}">Job Post</a></li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Job Post List</h4>
                        {{--                       @can('Create Admin')--}}
                        {{--                       @if(Auth::guard('admin')->user()->can('Create Admin'))--}}
                        <a class="btn btn-primary" href="{{route('admin.jobpost.create')}}" >
                            Create Post
                        </a>
                        {{--                        @endcan--}}
                        {{--                        @endif--}}
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#adminStatus', function () {
                ...
                $.ajax(
                    {
                        type: 'post',
                        url: "{{route('admin.jobpost.status')}}",
                        data: {
                            '_token': token,
                            id: id,
                            status: status
